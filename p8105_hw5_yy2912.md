...
``` r
output1 = 
  rerun(10, sim_regression(30, 2, 0)) %>% 
  bind_rows
```
...
<img src="p8105_hw5_yy2912_files/figure-gfm/unnamed-chunk-9-1.png" width="90%" />
...
<img src="p8105_hw5_yy2912_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />

From the plot, the average estimate of beta1 increases as the true value
of beta1 increases.
...
<img src="p8105_hw5_yy2912_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />

From the plot, only in samples for which the null was rejected, the
average estimate of beta1 decreases as the true value of beta1
increases.

The sample average of beta1 across tests for which the null is rejected
does not equal to the true value of beta1. The sample average is higher
because when we only take the average of beta1s when the null is
rejected, we excluded all zero beta1s (which only take the value of zero
